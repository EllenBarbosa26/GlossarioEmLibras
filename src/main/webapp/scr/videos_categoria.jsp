...
<%
    ...
    Categoria category = (Categoria) session.getAttribute("categoria");
%>
...
<main>
    ...
    <div class="conteiner-video">
                                <%-- VIDEOS ADICIONADOS NO BANCO DE DADOS APRESENTADOS POR CATEGORIA --%>
        <% if (videos != null) { %>
        <% for(int i=0; i<videos.size(); i++){ %>
        <div class="videos">
            <%
            ...
            %>
            <%if (videos.get(i).getCategoryId() == idCategoria){%>
